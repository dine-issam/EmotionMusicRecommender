...
class MyRandomCircles extends StatefulWidget {
  final Function(String?, String?) onMoodSelected;
  const MyRandomCircles({Key? key, required this.onMoodSelected})
      : super(key: key);
...
class _RandomCirclesState extends State<MyRandomCircles> {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        for (int i = 0; i < moodData.length; i++) {
          final double size = random.nextDouble() * 100 + 30;
          double left, top;
          Rect newPosition;
